    ...
    dbc.Row([
        dbc.Col(html.Div([
            ...
            html.Ul([
                ...
                html.Li("Status: One of 8 status categories in GEM data:"),
                    html.Ul([
                            html.Li("Announced: Projects that have been publicly reported in corporate or governmental planning documents or media coverage but not yet actively moving forward by applying for permits or seeking land, material, or financing."),
                            html.Li("Pre-construction: Projects that are actively moving forward in seeking governmental approvals, land rights, or financing (the sum of 'pre-permit' and 'permitted' statuses in the Global Coal Plant Tracker)."),
                            html.Li("Construction: Projects where site preparation and/or equipment installation are underway."),
                            html.Li("Shelved: Suspension of the project has been announced, or no progress has been observed for at least two years."),
                            html.Li("Shelved - inferred 2 y: Inferred status based on lack of observed progress for 2 years."),
                            html.Li("Operating: The project has been formally commissioned; commercial operation has begun."),
                            html.Li("Cancelled: A cancellation announcement for the project has been made, or no progress has been observed for at least four years."),
                            html.Li("Cancelled - inferred 4 y: Inferred status based on lack of observed progress for 4 years."),
                            html.Li("Mothballed: The project is disused, but not dismantled."),
                            html.Li("Retired: The project has been decommissioned or dismantled; this term is also used if the plant has been destroyed by war."),
                        ]),
